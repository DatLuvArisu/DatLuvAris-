...
local Window = OrionLib:MakeWindow({Name = "DatLuvArisú", HidePremium = false, IntroText = "DatLuvArisú⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
